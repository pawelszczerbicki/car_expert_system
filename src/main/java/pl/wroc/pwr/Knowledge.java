...
public class Knowledge {
    ...
    static {
        ...
        cars.addAll(Arrays.asList(
                new Car("Toyota", "Auris", 68000d, 5.5, 200, 10.0, 136d, 160d, 1.6, 5, HATCHBACK, PETROL),
                new Car("Skoda", "Octavia", 75000d, 5.0, 218, 8.5, 150d, 320d, 2.0, 5, LIFTBACK, DIESEL),
                new Car("Volkswagen", "Golf", 64000d, 5.2, 212, 8.4, 140d, 250d, 1.4, 5, HATCHBACK, PETROL),
                new Car("Opel", "Astra GTC", 85000d, 7.2, 220, 8.3, 180d, 230d, 1.6, 3, HATCHBACK, PETROL),
                new Car("Volkswagen", "Passat", 95000d, 5.8, 215, 9.0, 170d, 230d, 2.0, 5, SEDAN, DIESEL),
                new Car("Mazda", "6", 105000d, 6.2, 216, 9.1, 165d, 210d, 2.0, 5, SEDAN, PETROL),
                new Car("Ford", "Mondeo", 86000d, 5.3, 220, 8.9, 163d, 340d, 2.0, 5, SEDAN, DIESEL),
                new Car("BMW", "3", 128000d, 5.8, 235, 7.5, 184d, 380d, 2.0, 5, SEDAN, DIESEL),
                new Car("Audi", "A4", 120000d, 5.8, 226, 8.7, 170d, 230d, 2.0, 5, SEDAN, DIESEL),
                new Car("Toyota", "RAV4", 123000d, 6.8, 190, 9.6, 150d, 340d, 2.2, 5, SUV, DIESEL),
                new Car("Nissan", "Qashqai", 75000d, 6.5, 199, 9.0, 150d, 240d, 1.6, 5, SUV, PETROL),
                new Car("Nissan", "370Z", 192000d, 10.6, 250, 5.2, 344d, 371d, 3.7, 2, COUPE, PETROL),
                new Car("Mazda", "MX-5", 115000d, 7.8, 218, 7.9, 160d, 188d, 2.0, 2, ROADSTER, PETROL)
        ));
