...
public class Knowledge {
    ...
    private static Map<FeatureType, Question> questions = new LinkedHashMap<>(); //TODO sort or not????
    ...
    static{
        ...
        questions.put(ENGINE_CAPACITY, new Question(Type.OPEN, "What capacity", GAS.toString()));
